...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BO2rTU_k.mjs");
...
var manifest = { "b51ba868b218cc266648b121a37dc5b8a9fb44d85d3c0fd04cd14b98de306b51": {
	functionName: "getBronxWeather_createServerFn_handler",
	importer: () => import("./weather-DCPhoVRs.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B-dYI7Tg.mjs").then((n) => n.t),
